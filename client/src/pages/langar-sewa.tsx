      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid gap-4 sm:gap-6 md:gap-8 grid-cols-1 md:grid-cols-2">
          <Card>
            ...
            <CardContent className="space-y-3 sm:space-y-4">
              <p className="text-xs sm:text-sm text-muted-foreground">
                Langar is a tradition of serving free meals to all visitors,
                regardless of their background. Your contribution helps us
                maintain this sacred tradition and serve the community.
              </p>
          ...
          <Card>
            ...
            <CardContent className="space-y-3 sm:space-y-4">
              <p className="text-xs sm:text-sm text-muted-foreground">
                Langar, the community kitchen found at every Gurudwara, is a
                place where free meals are served to all visitors, regardless of
                their faith, religion, caste, gender, economic status, or
                ethnicity.
              </p>
              <p className="text-xs sm:text-sm text-muted-foreground">
                The tradition of Langar expresses the ethics of sharing,
                community, inclusiveness, and oneness of all humankind. Your
                contribution helps us continue this sacred tradition.
              </p>
